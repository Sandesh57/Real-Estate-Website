...
const Contact = () => {
  return (
    ...
    viewport={{once:true}} className='text-center p-6 py-20 lg:px-32  w-full overflow-hidden' i='Contact'>
        ...
        <p className='text-center text-gray-500  mb-12 max-w-80 mx-auto'>Ready to make a move</p>
